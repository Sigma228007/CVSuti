...
bot.command('start', (ctx) => {
 ...
 const firstName = ctx.from?.first_name ? `, ${ctx.from.first_name}` : '';
  const welcomeMessage = [
    `🎉 Привет${firstName}! Добро пожаловать в FK Casino.`,
    '💸 Пополняй баланс через FKWallet и выводи выигрыши в пару кликов.',
    '🎯 Делай ставки и наблюдай за активностью других игроков в реальном времени.',
    '▶️ Нажми «Играть», чтобы открыть мини-приложение и начать.',
    '🆘 Нужна помощь — команда /help всегда под рукой. Удачи! 🍀'
  ].join('\n\n');
